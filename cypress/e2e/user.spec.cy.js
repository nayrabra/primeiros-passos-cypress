...
describe("Orange HRM Tests", () => {
  ...
  it.only("User Info Update - Sucess", () => {
    ...
    cy.get(selectorsList.genericField).eq(6).clear().type('2027-04-19');
    cy.get(selectorsList.dateCloseButton).click();
    cy.get(selectorsList.genericField).eq(7).clear().type('2000-07-13');
    cy.get(selectorsList.dateCloseButton).click();
    cy.get(selectorsList.genericField).eq(8).clear().type('100');
